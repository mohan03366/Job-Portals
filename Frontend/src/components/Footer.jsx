    ...
    <footer className="mt-16 border-t border-white/10 bg-black/30 backdrop-blur">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-sm text-white/70 mb-4">
              Connecting talent with opportunity. Your future career starts
              here.
            </p>
            <p className="text-sm text-white/70">
              Development By Scalably Vision Pvt. Ltd.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="space-y-2">
              <p className="text-sm text-white/70">
                <a
                  href="mailto:info@placementempire.com"
                  className="hover:text-white transition-colors"
                >
                  support@placementempire.com
                </a>
              </p>
              <p className="text-sm text-white/70">
                <a
        ...
        <div className="mt-8 pt-6 border-t border-white/10 text-center">
          <p className="text-sm text-white/70">
            © {new Date().getFullYear()} Placement Empire. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
